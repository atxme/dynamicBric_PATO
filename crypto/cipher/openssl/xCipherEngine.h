...
//  defines the cipher engine types and functions using OpenSSL
//
...
typedef enum {
    ...
    XOS_CIPHER_MODE_XTS       // XEX-based tweaked-codebook mode with ciphertext stealing
} t_cipherMode;
...
typedef enum {
    ...
    XOS_CIPHER_PADDING_ZERO   // Zero padding
} t_cipherPadding;
